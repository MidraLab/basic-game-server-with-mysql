...
func TestParser_ReadIdentifier(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, got1 := p.ReadIdentifier()
			if got != tt.want {
				t.Errorf("Parser.ReadIdentifier() got = %v, want %v", got, tt.want)
			}
			if got1 != tt.want1 {
				t.Errorf("Parser.ReadIdentifier() got1 = %v, want %v", got1, tt.want1)
			}
		})
	}
}
...
func TestParser_ReadNumber(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := p.ReadNumber(); got != tt.want {
				t.Errorf("Parser.ReadNumber() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_isNum(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := isNum(tt.args.c); got != tt.want {
