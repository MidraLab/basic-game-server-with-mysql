...
func Test_genericTypeSpec_TypeName(t *testing.T) {
	type fields struct {
		ArrayDepth int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tr := &genericTypeSpec{
				ArrayDepth: tt.fields.ArrayDepth,
				TypeSpec:   tt.fields.TypeSpec,
				Name:       tt.fields.Name,
			}
			if got := tr.TypeName(); got != tt.want {
				t.Errorf("genericTypeSpec.TypeName() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_splitGenericsTypeName(t *testing.T) {
	type args struct {
		fullGenericForm string
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, got1 := splitGenericsTypeName(tt.args.fullGenericForm)
			if got != tt.want {
				t.Errorf("splitGenericsTypeName() got = %v, want %v", got, tt.want)
			}
			if !reflect.DeepEqual(got1, tt.want1) {
				t.Errorf("splitGenericsTypeName() got1 = %v, want %v", got1, tt.want1)
			}
		})
	}
}

func TestPackagesDefinitions_getParametrizedType(t *testing.T) {
	type fields struct {
		files             map[*ast.File]*AstFileInfo
		packages          map[string]*PackageDefinitions
		uniqueDefinitions map[string]*TypeSpecDef
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := pkgDefs.getParametrizedType(tt.args.genTypeSpec); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("PackagesDefinitions.getParametrizedType() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestPackagesDefinitions_resolveGenericType(t *testing.T) {
	type fields struct {
		files             map[*ast.File]*AstFileInfo
		packages          map[string]*PackageDefinitions
		uniqueDefinitions map[string]*TypeSpecDef
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := pkgDefs.resolveGenericType(tt.args.file, tt.args.expr, tt.args.genericParamTypeDefs); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("PackagesDefinitions.resolveGenericType() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_getExtendedGenericFieldType(t *testing.T) {
	type args struct {
		file                 *ast.File
		field                ast.Expr
		genericParamTypeDefs map[string]*genericTypeSpec
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := getExtendedGenericFieldType(tt.args.file, tt.args.field, tt.args.genericParamTypeDefs)
			if (err != nil) != tt.wantErr {
				t.Errorf("getExtendedGenericFieldType() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("getExtendedGenericFieldType() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_getGenericTypeName(t *testing.T) {
	type args struct {
		file  *ast.File
		field ast.Expr
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := getGenericTypeName(tt.args.file, tt.args.field)
			if (err != nil) != tt.wantErr {
				t.Errorf("getGenericTypeName() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("getGenericTypeName() = %v, want %v", got, tt.want)
			}
		})
	}
}
